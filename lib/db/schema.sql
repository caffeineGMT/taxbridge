...
-- Customer interviews table for tracking interview campaigns
...
CREATE INDEX IF NOT EXISTS idx_customer_interviews_status ON customer_interviews(status);
CREATE INDEX IF NOT EXISTS idx_customer_interviews_invited_at ON customer_interviews(invited_at);

-- Interview insights table for storing structured feedback from interviews
...
CREATE INDEX IF NOT EXISTS idx_interview_insights_interview_id ON interview_insights(interview_id);
CREATE INDEX IF NOT EXISTS idx_interview_insights_user_id ON interview_insights(user_id);
CREATE INDEX IF NOT EXISTS idx_interview_insights_nps ON interview_insights(net_promoter_score);

-- Referral messaging table for customer language-based marketing copy
